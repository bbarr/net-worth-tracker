...
export default ({ liability, onCancel }) => {

  const [ current, update ] = hooks.useState({ ...createStubLiabilityValuation(), accountId: liability.id, value: liability.value })
  ...
  return html`
    <div class="fixed inset-0 bg-white flex justify-center items-center dark:bg-gray-900">
      ...
      <form class="max-w-full w-[500px] p-6" onSubmit=${prevDef(onSubmit)}>
        <div class="mb-6 font-semibold text-2xl">Update balance of "${liability.label}"</div>
        <div class="mt-6">
